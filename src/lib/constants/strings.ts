...
export const PAYOUTS = {
  ...
  HERO_BADGE: "Daily rewards",
  TREND_TITLE: "Bonus payout trend",
  TREND_SUBTITLE: "Your daily share and the bonus pool over time",
  TREND_VIEW_SHARE: "Your share",
  TREND_VIEW_POOL: "Bonus pool",
  TREND_VIEW_BOTH: "Both",
  TREND_DAYS: "days shown",
  AVG_DAILY_SHARE: "Avg daily share",
  DAY_CHANGE: "vs previous day",
  HISTORY: "Payout history",
  HISTORY_SUBTITLE: "Settled bonus days — rank, pool, and payout status",
  COL_DATE: "Date",
  COL_RANK: "Rank",
