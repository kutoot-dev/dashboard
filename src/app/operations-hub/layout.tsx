...
export const metadata: Metadata = {
  title: "Operations Hub — Kutoot",
  description: "Partner with Kutoot to manage a portfolio of merchant locations",
};

export default function OperationsHubLayout({
  children,
}: {
    ...
    <div className="relative flex min-h-screen flex-col overflow-x-hidden">
      ...
      <header className="sticky top-0 z-30 border-b border-border/70 bg-background/95 backdrop-blur-sm">
        <div className="mx-auto flex max-w-3xl items-center justify-between px-4 py-5 sm:px-6 sm:py-3">
          <KutootLogo
            size="lg"
            className="h-20 w-auto max-w-[min(100%,22rem)] sm:h-7 sm:max-w-[min(100%,11rem)]"
          />
